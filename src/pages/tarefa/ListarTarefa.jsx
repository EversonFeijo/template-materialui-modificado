...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card  className="tabela">
        <CardHeader //Para estilizar no CSS = Mui+tag+propriedade -> .MuiCardHeader-title
          title="Tarefas"
        ...
        <CardContent>
            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="">
                <TableHead className='tabela-cabeca'>
                <TableRow>
                    <TableCell>#</TableCell>
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      ...
                      <TableCell align="center">
                        <Button className='editar-tarefa' variant="contained" color="success" onClick={() => handleEditar(row.idTarefa)}><EditIcon fontSize="small" /></Button>            
                      </TableCell>
                      <TableCell align="center">
                        <Button className='excluir-tarefa' variant="contained" color="error" onClick={() => handleDeletar(row.idTarefa)}><DeleteIcon fontSize="small" /></Button>            
                      </TableCell>
                    </TableRow>
                ))}
                </TableBody>
        ...
        <CardActions>
            <Button className="submit" size="small" variant="contained" onClick={handleOpen}>Criar Tarefa</Button>
            <Button className='cancel' size="small" variant="outlined">Cancelar</Button>
      </CardActions> 
    </Card>
    <div>
      <Modal
